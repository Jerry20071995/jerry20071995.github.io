          ...
          <div class="row footer-widgets">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="footer-widget contact-widget">
                <h4>
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/footer-logo.png" class="img-responsive" alt="Footer Logo" />
                </h4>
                <p>
              ...
              <div class="footer-widget recent-posts-widget">
                ...
                <ul class="recent-post">
                  <li class="post">
                    ...
                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/img-7.jpg">
                    </a>
                  ...
                  <li class="post">
                    ...
                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/img-8.jpg">
                    </a>
                    <p class="text">Fusce gravida tortor felis, ac dictum risus sagittis <br><span>January 3,2015</span></p>
                  </li>
                </ul>
              ...
              <div class="footer-widget flickr-widget">
                ...
                <ul class="flickr-list">
                  <li>
                    ...
                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/img-1.jpg">
                    </a>
                  </li>
                  <li>
                    <a href="assets/img/portfolio/img-2.jpg" class="lightbox">
                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/img-2.jpg">
                    </a>
                  </li>
                  <li>
                    <a href="assets/img/portfolio/img-3.jpg" class="lightbox">
                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/img-3.jpg">
                    </a>
                  </li>
                  <li>
                    <a href="assets/img/portfolio/img-4.jpg" class="lightbox">
                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/img-4.jpg">
                    </a>
                  </li>
                  <li>
                    <a href="assets/img/portfolio/img-5.jpg" class="lightbox">
                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/img-5.jpg">
                    </a>
                  </li>
                  <li>
                    <a href="assets/img/portfolio/img-6.jpg" class="lightbox">
                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/img-6.jpg">
                    </a>
                  </li>
                </ul>
              </div>
